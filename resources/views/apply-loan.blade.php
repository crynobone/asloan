            ...
            <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-2 sm:mt-0 sm:col-span-2">
                <div class="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input id="total" name="total" type="number" step="0.01" class="form-input block w-full pl-7 pr-12 sm:text-sm sm:leading-5 @error('total') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" placeholder="0.00" aria-describedby="total-currency" value="{{ old('total') }}">
